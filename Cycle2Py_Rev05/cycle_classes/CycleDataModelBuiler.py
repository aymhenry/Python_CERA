...
class CycleDataModelBuiler (DataModelBuiler):
	...
	DataModelBuiler.CONFIGRATION_ROW = 4#+1 			# set row number that has the configration
	...
	def assign_vars (self):
		...
		self.obj_qdata.setup_vars ( self.lst_data, lst_title, 1, self.CONFIGRATION_ROW -1, True)
	...
	# Compressor data
		...
		#  QHILO[1]		Normalized heat loss from dischange line inside the compressor shell to suction gas
