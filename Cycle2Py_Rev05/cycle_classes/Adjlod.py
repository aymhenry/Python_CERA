...
class Adjlod (Data):
	...
	def adjlod (self, ICYCL,IC,TS3, TS5, FROSTF,FROSTZ,IDFRST):
		...
		if IC == 1:
			...
			UFF = (Data.obj_cdata.FFQ - Data.obj_cdata.FFLAT - Data.obj_cdata.FFPENA - Data.obj_cdata.FFHTQ - FROSTF + Data.obj_cdata.QMUL)/(Data.obj_cdata.TROOM - Data.obj_cdata.FFTEMP)

			FZQ = Data.obj_cdata.FZQON
			FZQ_S = FZQ

			UFZ = (FZQ - Data.obj_cdata.FZLAT - Data.obj_cdata.FZPENA - Data.obj_cdata.FZHTQ - FROSTZ - Data.obj_cdata.QMUL)/(Data.obj_cdata.TROOM - Data.obj_cdata.FZTEMP)

			UFF_SEN = FFSEN_S/(Data.obj_cdata.TROOM - FFTEMP_S)
			UFZ_SEN = FZSEN_S/(Data.obj_cdata.TROOM - FZTEMP_S)

			UCND_F = (Data.obj_cdata.CONDF + Data.obj_cdata.QMUL)/(Data.obj_cdata.TROOM - FFTEMP_S)
			UCND_Z = (Data.obj_cdata.CONDZ - Data.obj_cdata.QMUL)/(Data.obj_cdata.TROOM - FZTEMP_S)
			...
			FFLOAD = Data.obj_cdata.DUTYE * Data.obj_cdata.CAPE + Data.obj_cdata.DUTYZ * Data.obj_cdata.Q_FZ_FF
			FZLOAD = Data.obj_cdata.DUTYZ * Data.obj_cdata.CAPZ
			DELLOD = (FFLOAD * Data.obj_cdata.CAPZ - FZLOAD * Data.obj_cdata.CAPE)/(Data.obj_cdata.CAPE + Data.obj_cdata.CAPZ)
			...
			if (DUTDIF  >=  0.025): Data.obj_cdata.IBLNCE = 1
			...
			if Data.obj_cdata.INCTRL == 0:
				...
				DAREAF = (Data.obj_cdata.DUTYE / DUTY_AVE - 1.0)*Data.obj_cdata.ATOTE
				DAREAZ = (Data.obj_cdata.DUTYZ / DUTY_AVE - 1.0)*Data.obj_cdata.AREAFZ
				...
				Data.obj_cdata.FFQ = DUTYN * Data.obj_cdata.CAPE + DUTYN * Data.obj_cdata.Q_FZ_FF + FROSTF_S
				DELTS3 = (Data.obj_cdata.FFQ - FFQ_S)/UFF

				TS3 = TS3_S - DELTS3 / 1.8
				Data.obj_cdata.FFTEMP_A = 1.8 * TS3 - 459.6

				Data.obj_cdata.FFSEN = UFF_SEN*(Data.obj_cdata.TROOM - Data.obj_cdata.FFTEMP_A)
				Data.obj_cdata.CONDF = UCND_F*(Data.obj_cdata.TROOM - Data.obj_cdata.FFTEMP_A) - Data.obj_cdata.QMUL
				...
				Data.obj_cdata.FZSEN = UFZ_SEN*(Data.obj_cdata.TROOM - Data.obj_cdata.FZTEMP_A)
				Data.obj_cdata.CONDZ = UCND_Z*(Data.obj_cdata.TROOM - Data.obj_cdata.FZTEMP_A) + Data.obj_cdata.QMUL
