...
def main ():
	...
	print ("	 USE RF12 -- for tessting -=-= obj_block2.bconst (NC, IR, FIN)")
	code = 2
	NC = 1
	IR = [0.0, code, 0,0,0,0] 
	...
	R12_TABLE_READING_S = 1 - 0.10487595665661611 	# kj/kg.K 1-app result at 0C need to be 1.0, valid only for RF12
	...
	print ("\n	 ---- Output ===========-")
	print ("		H in kJ/k-mole= %5.3f,  kJ/kg=%5.3f,  Reading in ASHRAE kJ/kg = %5.3f" %(H, H/MOLAR_WEIGHT, H/MOLAR_WEIGHT + R12_TABLE_READING) )
	...
	print ("\n	 ---- Output --")
	print ("		S in kJ/k-mole K= %5.3f,  kJ/kg K=%5.3f,  Reading in ASHRAE kJ/kg K= %5.3f" %(S, S/MOLAR_WEIGHT, S/MOLAR_WEIGHT + R12_TABLE_READING_S) )
	...
	Happ =  (Hbook - R12_TABLE_READING)*MOLAR_WEIGHT
	...
	print ("		HL in kJ/k-mole= %5.3f,  kJ/kg=%5.3f,  Reading in ASHRAE kJ/kg = %5.3f" %(HL, HL/MOLAR_WEIGHT, HL/MOLAR_WEIGHT + R12_TABLE_READING) )
	print ("		HV in kJ/k-mole= %5.3f,  kJ/kg=%5.3f,  Reading in ASHRAE kJ/kg = %5.3f" %(HV, HV/MOLAR_WEIGHT, HV/MOLAR_WEIGHT + R12_TABLE_READING) )

	#---------------------------------------------------------------
	Title ("	[T, XQ,XL,XV,  VL,VV,  HL,HV] = obj_block2.spin ( S,P,X )")
	Sbook =  1.168975  #related to XQ=.25%
	P = 448.95 # related to 12C
	S =  (Sbook - R12_TABLE_READING_S)*MOLAR_WEIGHT
	...
	print ("		SL in kJ/k-mole K= %5.3f,  kJ/kg K=%5.3f,  Reading in ASHRAE kJ/kg K= %5.3f" %(SL, SL/MOLAR_WEIGHT, SL/MOLAR_WEIGHT + R12_TABLE_READING_S) )
	print ("		SV in kJ/k-mole K= %5.3f,  kJ/kg K=%5.3f,  Reading in ASHRAE kJ/kg K= %5.3f" %(SV, SV/MOLAR_WEIGHT, SV/MOLAR_WEIGHT + R12_TABLE_READING_S) )
...
def bublt_test():
	...
	R12_TABLE_READING = 200.0- 26.2257538946007

	Hbook =  370
	P = 400
	Happ =  (Hbook - R12_TABLE_READING)*120.91
	#print ("  h  =", h, " in kj/kg", h/120.91, " reading in table ",  h/120.91 + R12_TABLE_READING)
	print ("		P=", P)
	print ("		Happ=", Happ)
	print ("		Hbook=", Happ/120.91 + R12_TABLE_READING)
	...
	print ("	book m3/kg K	HL=",  HL/120.91 + R12_TABLE_READING)
	
	print ("\n		HV=", HV)	
	print ("	m3/kg K	HV=", HV/120.91)
	print ("	book m3/kg K	HV=",  HV/120.91 + R12_TABLE_READING)
