...
class Ql2(CabUtils):
    ...
    def __init__(self, Cab):
        ...
        # -=-=-=-=-=-=-=-=-=-=-
        # python only
        DCF = H2F = D2F = H1F = DCZ = H2Z = D2Z = H1Z = D1F = D1Z = DCF = 0
        H2F = D3F = DCZ = H2Z = D3Z = D1F = D1Z = D2F = D2Z = 0

        AILSDE = RR = AIRSDE = AILBCK = AIRBCK = AILBOT = AILBTM1 = AOLBTM1 = AILBTM2 = 0
        AOLBTM2 = AILBTM3 = AOLBTM3 = AIRBOT = AIRBTM1 = AORBTM1 = AIRBTM2 = AORBTM2 = 0
        AIRBTM3 = AORBTM3 = QWFFC = QWFFB = 0
