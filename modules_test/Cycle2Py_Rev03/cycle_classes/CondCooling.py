...
class CondCool_CNat (CondCool_Abstract): #Data.ICOND== 0 
	#=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.==.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=
	def cond_balance (self, CPRLIQ):
...
class CondCool_CCross (CondCool_Abstract): #Data.ICOND== 1 
	#=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.==.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=
	def cond_balance (self, CPRLIQ):
		# replace TBUB with Cycle.obj_data.T[11]
		# replace PBUB with Cycle.obj_data.P[11]
		...
		return self.ccross (self.objData.TS1, \
							...
							self.objData.P[4],  self.objData.X,     Data.N_COND)
...
class CondCool_CCount(CondCool_Abstract): #Data.ICOND== 1 
	#=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.==.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=
	def cond_balance (self, CPRLIQ):
		# replace TBUB with Cycle.obj_data.T[11]
		# replace PBUB with Cycle.obj_data.P[11]
